...
public class EditorPanel extends PMPanel implements Runnable {
    ...
    public EditorPanel(JFrame fr) throws IOException {
        ...
        //UI
        //读谱
        cr = new ChartManager("./res/charts/"+ Editor.chart +"/chart.json");
        //note编辑
        ...
        JMenu fileMenu = new JMenu("文件");
            ...
            JMenuItem toNBT = new JMenuItem("转换为NBT");
        ...
        toNBT.addActionListener(e -> {
            //转换为nbt
            info.addInfo(cr.toNBTData());
        });
    ...
    public void putNote(){
        ...
        if(!cr.addNote(curr,curLine)){
            info.addInfo(1, new ClickOp(),"放置失败，note重叠");
            return;
        }
    ...
    public void save(){
        cr.save();
        info.addInfo(0, new ClickOp(),"保存成功");
        notSaved = false;
    ...
    public void newLine(){
            ...
            info.addInfo(0, new ClickOp(),"成功添加新判定线");
    }
